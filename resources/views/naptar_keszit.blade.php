...
body.dark h1 {
    ...
    * { box-sizing: border-box; }
    ...
    .time-group { display: flex; gap: 1rem; flex-wrap: wrap; }
...
/>
      ...
      <textarea name="description" id="description" rows="4" placeholder="Pl: B épület, előadó, vagy Plakát kocsma (helyszín)"></textarea>
      ...
      <div id="ertesites-info" class="info-box">
        🔔 Ha bekapcsolod az értesítést, a felhasználók Push Notification formájában is megkapják az eseményt. Csak fontos eseményekhez használd!
      </div>
