<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
      ...
      <ul>
        <li class="relative px-6 py-3">
          <span class="{{ Route::is('chart') ? 'absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg' : 'bsolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg' }} " aria-hidden="true"></span>
      ...
      <div class="px-6 my-6">
        <button
        onclick="window.location='{{ route('keszit') }}'"
        type="button"
