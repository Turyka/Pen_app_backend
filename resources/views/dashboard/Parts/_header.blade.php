      ...
      <ul class="flex items-center flex-shrink-0 space-x-6">
        ...
        <li class="relative">
          ...
          <template x-if="isProfileMenuOpen">
            <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click.away="closeProfileMenu" @keydown.escape="closeProfileMenu" stlye="z-index: 100 !important;" class="absolute right-20 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700" aria-label="submenu">
              <li class="flex">
                <!-- Hidden logout form -->
                ...
                <!-- Logout link -->
                <a href="#" style="z-index: 100 !important;" class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
        ...
        <span>Üdv: {{ Auth::user()->teljes_nev }}</span>
      </ul>
    </div>
  </header>